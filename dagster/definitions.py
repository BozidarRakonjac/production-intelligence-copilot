...
import os
from dagster.assets.bronze.bronze_machine_telemetry import bronze_machine_telemetry
from dagster.assets.bronze.bronze_downtime_logs import bronze_downtime_logs
from dagster.assets.bronze.bronze_quality_inspections import bronze_quality_inspections
from dagster.assets.bronze.bronze_production_events import bronze_production_events
